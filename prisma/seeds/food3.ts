...
export const food3 = {
  nameKo: "네츄럴랩 케어1 강아지사료 관절&눈(눈물)",
  nameEn: "Natural Lab care1 joint & eye",
  ...
  ingredients: {
    create: [
      ...
      { ingredientRaw: "비트펄프" },
      { ingredientRaw: "크릴오일(SPM OMEGA-3)" },
      { ingredientRaw: "인산칼슘" },
